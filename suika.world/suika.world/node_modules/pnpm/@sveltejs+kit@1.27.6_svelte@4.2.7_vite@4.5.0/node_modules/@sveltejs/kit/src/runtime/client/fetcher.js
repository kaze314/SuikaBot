...
if (DEV) {
  ...
  window.fetch = (input, init) => {
    ...
    const cutoff = stack_array.findIndex(
      (a) => a.includes("load@") || a.includes("at load")
    );
  ...
  if (cache.size > 0) {
    ...
    if (cached) {
      ...
      if (
        ...
        ["default", "force-cache", "only-if-cached", undefined].includes(
          opts?.cache
        )
      ) {
