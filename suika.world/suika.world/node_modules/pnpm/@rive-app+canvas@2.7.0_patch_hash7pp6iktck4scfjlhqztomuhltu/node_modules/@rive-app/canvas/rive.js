        ...
        var Rive = (() => {
          ...
          return function (moduleArg = {}) {
                ...
                a.set(
                  ...
                  setTimeout(function () {
                    ...
                    0 == a.length
                      ? (c = -Infinity)
                      : d == c &&
                        ((c = Math.max(...a.keys())), console.assert(c < d));
                  }, 1e3)
                );
                c = Math.max(d, c);
                return c << b;
              ...
              ka = new (function () {
                function b() {
                  if (!a) {
                    ...
                    d = Math.min(
                      n.getParameter(n.MAX_RENDERBUFFER_SIZE),
                ...
                this.Ab = function (t, g, n, w, H) {
                  if (b()) {
                    ...
                    x = r.push(w);
                    m != x &&
                      (a.bufferData(a.ARRAY_BUFFER, 8 * x, a.DYNAMIC_DRAW),
                      (m = x));
                    x = 0;
                    for (var J of n)
                      a.bufferSubData(a.ARRAY_BUFFER, x, J.Ra),
                        (x += 4 * J.Ra.length);
                    console.assert(x == 4 * w);
                    for (var Q of n)
                      a.bufferSubData(a.ARRAY_BUFFER, x, Q.mb),
                        (x += 4 * Q.mb.length);
                    ...
                    J = 0;
                    for (var aa of n)
                      a.bufferSubData(a.ELEMENT_ARRAY_BUFFER, J, aa.indices),
                    ...
                    for (const B of n) {
                      B.image.Ma != aa &&
                        (a.bindTexture(a.TEXTURE_2D, B.image.rb || null),
                        (aa = B.image.Ma));
                      B.Pb
                        ? (a.scissor(B.Va, A - B.Wa - B.cb, B.$b, B.cb),
                          (Q = !0))
                        : Q && (a.scissor(0, A - g, t, g), (Q = !1));
                      n = 2 / t;
                      const fa = -2 / g;
                      a.uniform4f(
                        e,
                      ...
                      a.uniform2f(
                        f,
                        B.xa[4] * n * B.Ga + n * (B.Va - B.Nb * B.Ga) - 1,
                        B.xa[5] * fa * B.Ha + fa * (B.Wa - B.Ob * B.Ha) + 1
                      );
            ...
            h.onRuntimeInitialized = function () {
              ...
              function c() {
                0 < J.length &&
                  (ka.Ab(A.drawWidth(), A.drawHeight(), J, Q, aa),
                  (J = []),
                  (aa = Q = 0),
                  A.reset(512, 512));
                for (const q of x) {
                  for (let _i = 0; _i < q.ja.length; _i++) {
                    if (_i >= q.ja.length - 18 && _i <= q.ja.length - 3) {
                      continue;
                    }
                    q.ja[_i]();
                  }
              ...
              var n = h.RenderImage.extend("CanvasRenderImage", {
                  ...
                  decode: function (q) {
                    ...
                    v.Fa && v.Fa(v);
                    var C = new Image();
                    C.src = URL.createObjectURL(
                      new Blob([q], { type: "image/png" })
                    );
                    C.onload = function () {
                      v.ob = C;
                      v.rb = ka.vb(C);
                ...
                H = f.extend("CanvasRenderPaint", {
                  ...
                  radialGradient: function (q, v, C, D) {
                    this.za = { kb: q, lb: v, Za: C, $a: D, Pa: [], Kb: !0 };
                  },
                  addStop: function (q, v) {
                    this.za.Pa.push({ color: q, stop: v });
                  },
                  ...
                  draw: function (q, v, C) {
                    ...
                    if (null != E) {
                      ...
                      E.Kb
                        ...
                        : (z = q.createLinearGradient(z, F, T, G));
              ...
              var B = (h.CanvasRenderer = m.extend("Renderer", {
                ...
                transform: function (q, v, C, D, z, E) {
                  ...
                  F.splice(
                    ...
                    F[G + 1] * C + F[G + 3] * D,
                    F[G] * z + F[G + 2] * E + F[G + 4],
                    F[G + 1] * z + F[G + 3] * E + F[G + 5]
                  );
                  this.ja.push(
                    this.ha.transform.bind(this.ha, q, v, C, D, z, E)
                  );
                },
                rotate: function (q) {
                  const v = Math.sin(q);
            ...
            "object" != typeof WebAssembly &&
              za("no native wasm support detected");
            var Aa,
              I,
              Ba = !1,
              Ca,
            ...
            function Va(b, a, c) {
              return Ua(b)
                .then((d) => WebAssembly.instantiate(d, a))
                .then((d) => d)
                .then(c, (d) => {
            ...
            function Wa(b, a) {
              ...
              return ya ||
                ...
                : fetch(c, { credentials: "same-origin" }).then((d) =>
                    WebAssembly.instantiateStreaming(d, b).then(
                      a,
                      function (e) {
            ...
            function Bb(b, a) {
              ...
              !!a.la !== !!a.ia &&
                Ab("Both smartPtrType and smartPtr must be specified");
              a.count = { value: 1 };
            ...
            function Jb(b, a, c = {}) {
              ...
              delete Hb[b];
              Gb.hasOwnProperty(b) &&
                ((a = Gb[b]), delete Gb[b], a.forEach((e) => e()));
            }
            function Y(b, a, c = {}) {
            ...
            function Mb(b, a, c) {
              if (void 0 === b[a].ga) {
                var d = b[a];
                b[a] = function () {
                  b[a].ga.hasOwnProperty(arguments.length) ||
                    R(
                      `Function '${c}' called with an invalid number of arguments (${arguments.length}) - expects one of (${b[a].ga})!`
                    );
            ...
            function Nb(b, a, c) {
              h.hasOwnProperty(b)
                ? ((void 0 === c ||
                    (void 0 !== h[b].ga && void 0 !== h[b].ga[c])) &&
                    R(`Cannot register public name '${b}' twice`),
                  Mb(h, b, b),
                  h.hasOwnProperty(c) &&
                    R(
              ...
              !this.Da &&
                ...
                R(
                  `Cannot convert argument of type ${
                    a.ba.la ? a.ba.la.name : a.ba.ea.name
            ...
            function Tb(b, a) {
              ...
              a.ba.ea.Da &&
                R(
                  `Cannot convert argument of type ${a.ba.ea.name} to parameter type ${this.name}`
                );
              return Pb(a.ba.da, a.ba.ea.ca, this.ca);
            }
            function Ub(b, a, c, d) {
              ...
              void 0 !== a.fa
                ? (this.toWireType = Sb)
                : ((this.toWireType = d ? Qb : Tb), (this.ka = null));
            }
            function Vb(b, a, c) {
              h.hasOwnProperty(b) || Ab("Replacing nonexistant public symbol");
              void 0 !== h[b].ga && void 0 !== c
                ? (h[b].ga[c] = a)
                : ((h[b] = a), (h[b].va = c));
            }
            var Wb = (b, a) => {
            ...
            function Z(b, a) {
              ...
              "function" != typeof c &&
                R(`unknown function pointer with signature ${b}: ${a}`);
              return c;
            }
            var Xb = void 0;
            function Yb(b, a) {
              function c(f) {
                e[f] ||
                  kb[f] ||
                  (Hb[f] ? Hb[f].forEach(c) : (d.push(f), (e[f] = !0)));
              }
              var d = [],
                e = {};
              a.forEach(c);
            ...
            function Zb(b, a, c, d, e) {
              ...
              return function () {
                arguments.length !== k &&
                  R(
                    `function ${b} called with ${arguments.length} arguments, expected ${k} args!`
                  );
                t.length = 0;
                u.length = m ? 2 : 1;
                u[0] = e;
            ...
            function ac(b, a, c) {
              ...
              b instanceof a.ca.constructor ||
                R(
                  `${c} incompatible with "this" of type ${b.constructor.name}`
                );
              b.ba.da ||
                R(
            ...
            var Fc = (b, a, c, d) => {
              function e(g, n, w) {
                for (
                  g = "number" == typeof g ? g.toString() : g || "";
                  g.length < n;
              ...
              function m(g, n) {
                ...
                var H;
                0 === (H = w(g.getFullYear() - n.getFullYear())) &&
                  0 === (H = w(g.getMonth() - n.getMonth())) &&
                  (H = w(g.getDate() - n.getDate()));
                return H;
              }
              function l(g) {
                switch (g.getDay()) {
              ...
              function p(g) {
                var n = g.ta;
                for (
                  g = new Date(new Date(g.ua + 1900, 0, 1).getTime());
                  0 < n;
              ...
              k = {
                ...
                "%w": (g) => g.na,
                "%W": (g) =>
                  f(Math.floor((g.ta + 7 - ((g.na + 6) % 7)) / 7), 2),
                ...
                "%z": (g) => {
                  ...
                  return (
                    (n ? "+" : "-") +
                    String("0000" + ((g / 60) * 100 + (g % 60))).slice(-4)
                  );
                },
                "%Z": (g) => g.Zb,
                "%%": () => "%",
            ...
            Ub.prototype.fromWireType = function (b) {
              function a() {
                return this.Ea
                  ? Bb(this.ca.ma, { ea: this.Qb, da: c, la: this, ia: b })
                  : Bb(this.ca.ma, { ea: this, da: b });
              }
              var c = this.Fb(b);
              ...
              return null === e
                ? a.call(this)
                : this.Ea
                ? Bb(d.ca.ma, { ea: d, da: e, la: this, ia: b })
                : Bb(d.ca.ma, { ea: d, da: e });
            };
            ...
            var Jc = {
              N: function (b, a, c) {
                ...
                f.__construct = function () {
                  ...
                  k = jb(e, k);
                  ib.hasOwnProperty(k)
                    ? R(`Tried to register registered instance: ${k}`)
                    : (ib[k] = this);
                };
                f.__destruct = function () {
                  ...
                  ib.hasOwnProperty(k)
                    ? delete ib[k]
                    : R(`Tried to unregister unregistered instance: ${k}`);
                };
              ...
              f: function (b, a, c, d, e, f, m, l, p, k, r, u, t) {
                ...
                X([b, a, c], d ? [d] : [], function (n) {
                  ...
                  A.fa &&
                    (void 0 === A.fa.Ca && (A.fa.Ca = []), A.fa.Ca.push(A));
                  w = new Ub(r, A, !0, !1);
                  H = new Ub(r + "*", A, !1, !1);
                  ...
                  X([], l, function (t) {
                    ...
                    if (p.ca.Ca)
                      for (const g of p.ca.Ca)
                        g.constructor.hasOwnProperty(a) ||
                          (g.constructor[a] = t);
                    return [];
                  });
                  return [];
              ...
              a: function (b, a, c, d, e, f, m, l) {
                ...
                X([], [b], function (k) {
                  ...
                  var t = k.ca.ma,
                    g = t[a];
                  void 0 === g ||
                  (void 0 === g.ga && g.className !== k.name && g.va === c - 2)
                    ? ((r.va = c - 2), (r.className = k.name), (t[a] = r))
                    : (Mb(t, a, u), (t[a].ga[c - 2] = r));
                  X([], p, function (n) {
                    n = Zb(u, n, k, f, m);
                    void 0 === t[a].ga
                      ? ((n.va = c - 2), (t[a] = n))
              ...
              m: function (b, a, c, d, e, f) {
                ...
                X([], m, function (l) {
                  Vb(
                    b,
                    Zb(b, [l[0], null].concat(l.slice(1)), null, e, f),
                    a - 1
                  );
                  return [];
                });
              ...
              u: function (b, a, c) {
                ...
                if (2 === a) {
                  ...
                  4 === a &&
                    ((d = oc), (e = pc), (f = qc), (m = () => O), (l = 2));
                Y(b, {
                  name: c,
                  fromWireType: function (p) {
                    for (
                      var k = O[p >> 2], r = m(), u, t = p + 4, g = 0;
                      g <= k;
                      ++g
                    ) {
                      var n = p + 4 + g * a;
                  ...
                  toWireType: function (p, k) {
                    "string" != typeof k &&
                      R(`Cannot pass non-string to C++ string type ${c}`);
                    var r = f(k),
                      u = Ic(4 + r + a);
                    O[u >> 2] = r >> l;
                    e(k, u + 4, r + a);
              ...
              Q: function (b, a, c, d, e, f) {
                Db[b] = { name: V(a), Oa: Z(c, d), ra: Z(e, f), ab: [] };
              },
              ...
              h: function (b, a) {
                ...
                e = uc((m, l, p, k) => {
                  for (var r = 0, u = 0; u < b - 1; ++u)
                    (f[u] = c[u + 1].readValueFromPointer(k + r)),
                      (r += c[u + 1].argPackAdvance);
                  m = m[l].apply(m, f);
            ...
            (function () {
              function b(c) {
                ...
                if (
                  0 == Na &&
                  (null !== Oa && (clearInterval(Oa), (Oa = null)), Pa)
                ) {
                  var d = Pa;
                  Pa = null;
                  d();
            ...
            h.__embind_initialize_bindings = () =>
              (h.__embind_initialize_bindings = I.W)();
            h.dynCall_jiji = (b, a, c, d, e) =>
              (h.dynCall_jiji = I.Y)(b, a, c, d, e);
            h.dynCall_viijii = (b, a, c, d, e, f, m) =>
              (h.dynCall_viijii = I.Z)(b, a, c, d, e, f, m);
            h.dynCall_iiiiij = (b, a, c, d, e, f, m) =>
              (h.dynCall_iiiiij = I._)(b, a, c, d, e, f, m);
            h.dynCall_iiiiijj = (b, a, c, d, e, f, m, l, p) =>
              (h.dynCall_iiiiijj = I.$)(b, a, c, d, e, f, m, l, p);
            h.dynCall_iiiiiijj = (b, a, c, d, e, f, m, l, p, k) =>
              (h.dynCall_iiiiiijj = I.aa)(b, a, c, d, e, f, m, l, p, k);
            var Kc;
            Pa = function Lc() {
              Kc || Mc();
              Kc || (Pa = Lc);
      ...
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ BLANK_URL: () =>
            /* reexport safe */ _sanitizeUrl__WEBPACK_IMPORTED_MODULE_1__.BLANK_URL,
          ...
          /* harmony export */ sanitizeUrl: () =>
            /* reexport safe */ _sanitizeUrl__WEBPACK_IMPORTED_MODULE_1__.sanitizeUrl,
          /* harmony export */
        });
        /* harmony import */ var _registerTouchInteractions__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(4);
        /* harmony import */ var _sanitizeUrl__WEBPACK_IMPORTED_MODULE_1__ =
      ...
      /***/ (
        ...
        var getClientCoordinates = function (event) {
          ...
          if (
            ...
            ((_a = event.touches) === null || _a === void 0
              ? void 0
              : _a.length)
          ) {
            ...
            event.type === "touchend" &&
            ((_b = event.changedTouches) === null || _b === void 0
              ? void 0
              : _b.length)
          ) {
            return {
      ...
      var Rive = /** @class */ (function () {
        ...
        Rive.prototype.setupRiveListeners = function () {
          ...
          if (!this.shouldDisableRiveListeners) {
            ...
            this.eventCleanup = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.registerTouchInteractions)({
              canvas: this.canvas,
        ...
        Rive.prototype.draw = function (time, onSecond) {
          ...
          for (
            var _a = 0, activeStateMachines_1 = activeStateMachines;
            _a < activeStateMachines_1.length;
            _a++
          ) {
                  ...
                  if (event_1.type === RiveEventType.OpenUrl) {
                    ...
                    if (this.automaticallyHandleEvents) {
                      ...
                      var _b = event_1,
                        ...
                        target = _b.target;
                      var sanitizedUrl = (0,
                      _utils__WEBPACK_IMPORTED_MODULE_2__.sanitizeUrl)(url);
                      url && newAnchorTag.setAttribute("href", sanitizedUrl);
                      target && newAnchorTag.setAttribute("target", target);
                      if (
                        sanitizedUrl &&
                        sanitizedUrl !==
                          _utils__WEBPACK_IMPORTED_MODULE_2__.BLANK_URL
                      ) {
                        newAnchorTag.click();
                      }
                    }
        ...
        Rive.prototype.reset = function (params) {
          ...
          var stateMachineNames = mapToStringArray(
            params === null || params === void 0 ? void 0 : params.stateMachines
          );
          var autoplay =
            (_a =
              params === null || params === void 0
