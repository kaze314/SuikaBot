...
export function set_custom_element_data(node, prop, value) {
  ...
  if (lower in node) {
    node[lower] =
      typeof node[lower] === "boolean" && value === "" ? true : value;
...
export const resize_observer_content_box =
  /* @__PURE__ */ new ResizeObserverSingleton({
    box: "content-box",
  });
export const resize_observer_border_box =
  /* @__PURE__ */ new ResizeObserverSingleton({
    box: "border-box",
  });
export const resize_observer_device_pixel_content_box =
  /* @__PURE__ */ new ResizeObserverSingleton({
...
export class HtmlTag {
  ...
  m(html, target, anchor = null) {
    if (!this.e) {
      if (this.is_svg)
        this.e = svg_element(
          /** @type {keyof SVGElementTagNameMap} */ (target.nodeName)
        );
...
function escape_attribute(attribute) {
  return String(attribute).replace(
    regex_attribute_characters_to_escape,
    (match) => escaped[match]
  );
}
